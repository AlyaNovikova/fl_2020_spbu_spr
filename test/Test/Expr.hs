...
unit_parseExpr = do
    ...
    runParser parseExpr "2^31||x" @?= Success "" (BinOp Or (BinOp Pow (Num 2) (Num 31)) (Ident "x"))
    runParser parseExpr "2&&3||x&&y" @?= Success "" (BinOp Or (BinOp And (Num 2) (Num 3)) (BinOp And (Ident "x") (Ident "y")))
